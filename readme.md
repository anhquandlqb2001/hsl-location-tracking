# Fork from project Helsinki Transit System - Real-Time Vehicle Tracking with Redis

- This project appling replication for PostGIS service for demo on optimizing performance.
- Also modified to be able to running on ARM64 (M1 Chip)
